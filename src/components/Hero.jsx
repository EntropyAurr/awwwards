...
function Hero() {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: "polygon(14% 0%, 77% 0%, 90% 90%, 0% 100%)",
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      <div id="video-frame" className="bg-green-75 relative z-10 h-dvh w-screen overflow-hidden rounded-lg">
        <div>
        ...
        <div className="absolute top-0 left-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="hero-heading text-green-75">
              redefi<b className="special-font">n</b>e
            </h1>

            <p className="font-robert-regular mb-5 max-w-64 text-green-100">
